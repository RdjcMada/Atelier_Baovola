    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        ...
        try{
            ...
            Date dateentree = java.sql.Date.valueOf((request.getParameter("dateentree")));
            int idtypempiasa = Integer.parseInt(request.getParameter("idtypempiasa"));
            co.openAll();
            
            Personne pers = new Personne(0, nom, dateentree, idtypempiasa);
            pers.insert(co.getConnectionPostgres());
