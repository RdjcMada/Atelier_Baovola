 ...
 * @author Sahy
 */
public class PreInsertionPersonne extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            co.openAll();
            Personne[] personnes = new Personne().find("idpersonne>0", co.getConnectionPostgres());
            ...
            this.getServletContext().getRequestDispatcher("/Insertion/personne.jsp").forward(request, response);
        }catch(Exception ex){
            ex.printStackTrace();
            out.print(ex);
